...
async function * flatMapGen (iter, func) {
  for await (const elem of iter) {
    yield * await func(elem);
  }
}
...
class AsyncSequence {
  ...
  drop (num = 0) {
    ...
    return new AsyncSequence(dropGen(this._iterable, num));
  }
  ...
  take (num = 0) {
    ...
    return new AsyncSequence(takeGen(this._iterable, num));
  }
  ...
  dropWhile (func = ID) {
    ...
    return new AsyncSequence(dropWhileGen(this._iterable, func));
  }
  ...
  takeWhile (func = ID) {
    ...
    return new AsyncSequence(takeWhileGen(this._iterable, func));
  }
  ...
  filter (func = ID) {
    ...
    return new AsyncSequence(filterGen(this._iterable, func));
  }
  ...
  map (func = ID) {
    ...
    return new AsyncSequence(mapGen(this._iterable, func));
  }
  ...
  flatMap (func = ID) {
    ...
    return new AsyncSequence(flatMapGen(this._iterable, func));
  }
  ...
  async reduce (reducer, init) {
    ...
    for await (const elem of this._iterable) {
      accumulated = isFirst ? elem : await reducer(accumulated, elem);
      isFirst = false;
    }
